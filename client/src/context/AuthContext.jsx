...
import { initiateSocketConnection as initiateSocket, disconnectSocket, getSocket } from '../services/socket';
...
export const AuthProvider = ({ children }) => {
  ...
  const sendOtp = async (phoneNumber) => {
      ...
      return res.data; // Return data for UI to use (e.g. show OTP)
  };
